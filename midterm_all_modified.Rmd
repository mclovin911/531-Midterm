...
Agian, in order to check the goodness of fit of the SARMA(1, 1) model, we will look at its residuals.
Based on the residual ACF, there is no strong evidence for autocorrelation between the residual values at different lags.
...
Entong Li: Writing the model formula and notatio part, and seasonal ARIMA part.
